    ...
    try {
        ...
        const propertiesData = [
            {
                ...
                description: "Experience premium living in this spacious 3 BHK apartment with sea view. Features modern amenities, Italian marble flooring, and 24/7 security.",
                listingType: "buy",
                ...
                amenities: ["gym", "swimming-pool", "clubhouse", "gated-security", "parking", "lift", "power-backup"],
            ...
            },
            {
                ...
                description: "Beautiful independent villa with private garden and terrace. Located in a gated community with top-class amenities.",
                listingType: "buy",
                propertyType: "villa",
                price: 32000000,
                location: {
                ...
                amenities: ["garden", "clubhouse", "swimming-pool", "gym", "gated-security", "playground"],
            ...
            },
            {
                ...
                description: "Ready-to-move commercial office space. Ideal for startups and IT companies. Walking distance from metro station.",
                listingType: "rent",
                propertyType: "office",
                price: 85000,
                location: {
                ...
                amenities: ["air-conditioning", "power-backup", "gated-security", "cctv", "internet"],
            ...
            },
            {
                ...
                description: "Cozy 2 BHK apartment in the heart of the city. Close to parks, restaurants, and metro station. Perfect for small families.",
                listingType: "rent",
                propertyType: "apartment",
                price: 35000,
                location: {
                ...
                amenities: ["gated-security", "parking", "water-supply", "power-backup", "lift"],
            ...
            },
            {
                ...
                description: "Premium builder floor in GK-1. High-end interiors, modular kitchen, and exclusive terrace rights.",
                listingType: "buy",
                propertyType: "apartment",
                price: 65000000,
                location: {
            ...
            },
            {
                ...
                description: "Ideal for IT professionals. Walking distance from IT park. Gated society with all basic amenities.",
                listingType: "rent",
                propertyType: "apartment",
                price: 18000,
                location: {
                ...
                amenities: ["lift", "power-backup", "gated-security", "garden", "shopping-center"],
            ...
            },
            {
                ...
                description: "Ultra-luxury villa with premium finishes, smart home automation, private pool and tennis court. Located in an exclusive gated community.",
                listingType: "buy",
                propertyType: "villa",
                price: 85000000,
                location: {
                ...
                amenities: ["swimming-pool", "gym", "clubhouse", "gated-security", "garden", "playground", "power-backup"],
            ...
            },
            {
                ...
                description: "Ideal commercial plot for retail/office development. Located on main road with excellent connectivity. High visibility location.",
                listingType: "buy",
                propertyType: "plot",
                price: 25000000,
                location: {
            ...
            },
            {
                ...
                description: "Beautiful duplex villa with excellent natural light, private terrace, and modern amenities. Perfect for family living.",
                listingType: "rent",
                propertyType: "house",
                price: 45000,
                location: {
                ...
                amenities: ["gated-security", "parking", "garden", "water-supply", "power-backup"],
            ...
            },
            {
                ...
                description: "Ready-to-use retail shop in high-traffic commercial area. Perfect for retail business, salon, or food outlet.",
                listingType: "rent",
                propertyType: "shop",
                price: 35000,
                location: {
            ...
            },
            {
                ...
                description: "Large industrial warehouse with high ceiling and clear span. Suitable for manufacturing and storage. Loading dock available.",
                listingType: "rent",
            ...
            },
            {
                ...
                description: "Spacious farmhouse with organic farming setup, guest house, and scenic countryside views. Weekend retreat perfect for nature lovers.",
                listingType: "buy",
                ...
                amenities: ["garden", "playground", "gated-security", "parking", "water-supply"],
            ...
            },
            {
                ...
                description: "Modern apartment in the heart of Koramangala, a vibrant neighborhood. Walking distance to restaurants, cafes, and shopping centers.",
                listingType: "rent",
                propertyType: "apartment",
                price: 40000,
                location: {
                ...
                amenities: ["gym", "parking", "gated-security", "power-backup", "water-supply"],
                highlights: ["Vibrant Neighborhood", "Fully Furnished", "Walk to Cafes"],
                images: [
                    { url: "https://images.unsplash.com/photo-1522708323590-d24dbb6b0267?auto=format&fit=crop&w=1000&q=80" },
                    { url: "https://images.unsplash.com/photo-1502672260266-1c1ef2d93688?auto=format&fit=crop&w=1000&q=80" }
                ],
            ...
            },
            {
                ...
                description: "Exclusive penthouse with private rooftop garden and panoramic views. Located in a prestigious gated community.",
                listingType: "buy",
                propertyType: "apartment",
                price: 75000000,
                location: {
                ...
                amenities: ["gym", "swimming-pool", "parking", "gated-security", "cctv", "power-backup"],
            ...
            },
            {
                ...
                description: "Cozy studio apartment perfect for working professionals and students. Modern facilities and great connectivity.",
                listingType: "rent",
                propertyType: "apartment",
                price: 15000,
                location: {
            ...
            },
            {
                ...
                description: "Prime showroom space with high visibility and excellent foot traffic. Perfect for premium brands and retail outlets.",
                listingType: "rent",
                propertyType: "shop",
                price: 150000,
                location: {
                ...
                amenities: ["parking", "water-supply", "power-backup", "air-conditioning"],
            ...
            },
            {
                ...
                description: "Modern townhouse with private garden and terrace. Located near schools, hospitals, and shopping malls.",
                listingType: "rent",
                propertyType: "house",
                price: 50000,
                location: {
        ...
        for (const propData of propertiesData) {
            try {
                ...
                console.error(`Failed to create property ${propData.title}:`, err.message);
            }
        }
                ...
                await Review.insertMany([
                    {
                        ...
                        rating: 5,
                        title: "Amazing view!",
                        comment: "The sea view from the balcony is breathtaking. The apartment is well-maintained and the society is very peaceful.",
                    },
                    {
                        ...
                        comment: "Loved the villa and the community amenities. Security is top-notch. A bit far from the city center though.",
                    },
                    {
                        ...
                        comment: "Excellent connectivity, professional environment, and great amenities. Highly recommend for startups!",
                    },
                    {
                        ...
                        comment: "Great location near metro station. Very convenient for daily commute. Maintenance is good.",
                    },
                    {
                        ...
                        comment: "Spectacular builder floor in a prime location. Modern interiors and amazing views. Worth every penny!",
                    },
                    {
                        ...
                        comment: "Perfect location for young professionals. Lots of cafes and restaurants nearby. Great apartment!",
                    },
                    {
                        ...
                        comment: "Spacious townhouse with beautiful garden. Safe and secure community. Kids love the area.",
                    },
                    {
                        ...
                        comment: "Compact but well-designed studio. Perfect for professionals. Value for money!",
                    },
                ]);
                ...
                await Inquiry.insertMany([
                    {
                        ...
                        sender: buyerId,
                        receiver: sellerId,
                        message: "Hi, I am interested in this property. Is the price negotiable?",
                        phone: "9876543212",
                        status: "pending",
                    },
                    {
                    ...
                    },
                    {
                        ...
                        sender: buyerId,
                        receiver: sellerId,
                        message: "Is home loan available for this property? Interested in buying.",
                        phone: "9876543212",
                        status: "responded",
                    },
                    {
                    ...
                    },
                    {
                        ...
                        sender: buyerId,
                        receiver: sellerId,
                        message: "Is the property furnished or semi-furnished? Can it be modified?",
                        phone: "9876543212",
                        status: "pending",
                    },
                    {
                ...
                const projectsData = [
                    {
                        ...
                        description: "A premium residential project featuring lush green surroundings and world-class amenities.",
                        developer: sellerId,
                        location: {
                            address: "Sector 45",
                            city: "Gurgaon",
                        ...
                        amenities: ["gym", "swimming-pool", "clubhouse", "gated-security", "garden"],
                        images: [
                            { url: "https://images.unsplash.com/photo-1545324418-cc1a3fa10c00?auto=format&fit=crop&w=1000&q=80", caption: "Project Overview" }
                        ],
                    ...
                    },
                    {
                        ...
                        description: "Ultra-luxury apartments with panoramic city views and modern sky lounges.",
                        developer: sellerId,
                        location: {
                        ...
                        amenities: ["swimming-pool", "gym", "power-backup", "gated-security", "cctv"],
                        images: [
                            { url: "https://images.unsplash.com/photo-1512917774080-9991f1c4c750?auto=format&fit=crop&w=1000&q=80", caption: "Skyline View" }
                        ],
                    ...
                    },
                    {
                        ...
                        description: "Eco-friendly residential project with landscaped gardens and sustainable living features.",
                        developer: sellerId,
                        location: {
                        ...
                        amenities: ["garden", "gym", "swimming-pool", "clubhouse", "parking"],
                        images: [
                            { url: "https://images.unsplash.com/photo-1600585152220-90363fe7e115?auto=format&fit=crop&w=1000&q=80", caption: "Green Surroundings" }
                        ],
                        status: "ready-to-move",
                        reraId: "RERA55443322",
                        isVerified: true,
                    ...
                    },
                    {
                        ...
                        description: "Commercial and residential mixed-use development in prime location with retail space and office complexes.",
                        developer: sellerId,
                        location: {
                        ...
                        amenities: ["parking", "lift", "cctv", "power-backup", "air-conditioning"],
                        images: [
                            { url: "https://images.unsplash.com/photo-1486406146926-c627a92ad1ab?auto=format&fit=crop&w=1000&q=80", caption: "Commercial Complex" }
                        ],
                        status: "under-construction",
                        reraId: "RERA11223344",
                        isVerified: true,
                    ...
                    },
                    {
                        ...
                        description: "Luxury villa community with private landscaping, gated entrances, and exclusive resident amenities.",
                        developer: sellerId,
                        location: {
                            address: "DLF Phase 5",
                            city: "Gurgaon",
                        ...
                        amenities: ["swimming-pool", "clubhouse", "garden", "gated-security", "playground"],
                        images: [
                            { url: "https://images.unsplash.com/photo-1580587771525-78b9dba3b91d?auto=format&fit=crop&w=1000&q=80", caption: "Villa Complex" }
                        ],
                        status: "ready-to-move",
                        reraId: "RERA77889900",
                        isVerified: true,
                    ...
                    },
                    {
                        ...
                        description: "State-of-the-art commercial office spaces designed for IT and tech companies with world-class infrastructure.",
                        developer: sellerId,
                        location: {
                            address: "HITEC City",
                            city: "Hyderabad",
                        ...
                        amenities: ["air-conditioning", "power-backup", "cctv", "parking", "lift"],
                        images: [
                            { url: "https://images.unsplash.com/photo-1497366216548-37526070297c?auto=format&fit=crop&w=1000&q=80", caption: "Modern Office Space" }
                        ],
                        status: "ready-to-move",
                        reraId: "RERA33445566",
                        isVerified: true,
