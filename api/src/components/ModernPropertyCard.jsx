...
import { FiHeart, FiMapPin, FiStar, FiEdit, FiHome, FiMaximize } from "react-icons/fi";
...
const ModernPropertyCard = ({ property, onReserve }) => {
    ...
    const image = getImageUrl(images?.[0]?.url || images?.[0]) || "https://images.unsplash.com/photo-1600596542815-ffad4c1539a9?w=800";
    ...
    return (
        <div className="modern-property-card">
            <div className="modern-card-image-container">
                ...
                <div className="modern-card-price-tag">
                    ${price} Night
                </div>
                ...
                <div className="modern-card-content">
                    <div className="modern-card-header">
                        ...
                        <div className="modern-card-rating">
                            ...
                            <span>{rating} <span className="rating-count">({reviewsCount})</span></span>
                        </div>
                    </div>

                    <div className="modern-card-location">
                        <FiMapPin />
                        <span>{typeof location === 'string' ? location : `${location.address || ''} ${location.city || ''}`}</span>
                    </div>
                    ...
                    <div className="modern-card-footer">
                        <button className="reserve-btn" onClick={(e) => {
                            e.preventDefault();
                            e.stopPropagation();
