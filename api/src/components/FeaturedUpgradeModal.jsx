...
import { FiX, FiStar, FiCheck, FiCreditCard, FiShield, FiZap } from "react-icons/fi";
...
const FeaturedUpgradeModal = ({ property, onClose, onSuccess }) => {
    ...
    return (
        <div className="fum-overlay" onClick={(e) => e.target === e.currentTarget && step !== "processing" && onClose()}>
            <div className="fum-modal">
                ...
                {step === "idle" && (
                    <>
                        ...
                        <div className="fum-benefits">
                            <div className="fum-benefit"><FiZap /> Homepage featured section</div>
                            <div className="fum-benefit"><FiZap /> Priority in search results</div>
                            <div className="fum-benefit"><FiZap /> Star badge on listing</div>
                            <div className="fum-benefit"><FiZap /> 30 days of visibility</div>
                        </div>
                        ...
                        <div className="fum-actions">
                            <button className="fum-btn-cancel" onClick={onClose}>Cancel</button>
                ...
                {step === "processing" && (
                    <div className="fum-processing">
                        ...
                        <p className="fum-processing-sub">Please do not close this window.</p>
                    </div>
                )}
                ...
                {step === "success" && (
                    <div className="fum-success">
                        ...
                        {transaction && (
                            <p className="fum-txn-id">Ref: {transaction.id}</p>
                        )}
