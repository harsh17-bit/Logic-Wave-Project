    ...
    <div className="dashboard-page seller-dashboard">
              ...
              <div className="stats-grid seller-stats">
                ...
                <div className="stat-card">
                  <div className="stat-icon">
                    ...
                    >
                      <path
                        d="M8.38 12l2.41 2.42 4.83-4.84004"
                        stroke="#292D32"
                        strokeWidth="1.5"
                        strokeLinecap="round"
                ...
                <div className="stat-card">
                  <div className="stat-icon">
                    ...
                    >
                      <path
                        d="M12.864 7.37071c.7698 1.47399 1.1598 3.11669 1.1349 4.77939C13.9739 13.8128 13.5347 15.4431 12.721 16.8933L4 12l8.864-4.62929z"
                        fill="#2A4157"
                        fillOpacity=".24"
                      />
                      <path
                        d="M14.5 5.5c-2.7811 3.70812-9.85912 6.1272-10.87726 6.4605C3.57878 11.9748 3.57584 12.0335 3.61809 12.0523 4.61914 12.4983 11.7146 15.7146 14.5 18.5"
                        stroke="#222"
                        strokeLinecap="round"
                      />
                      <path
                        fillRule="evenodd"
                        clipRule="evenodd"
                        d="M13.5498 9.03334C13.862 10.0385 14.0148 11.0902 13.9989 12.1501 13.9845 13.1091 13.8323 14.0572 13.5499 14.9663 12.1066 14.7491 11 13.5037 11 11.9998s1.1065-2.74926 2.5498-2.96646z"
                        fill="#222"
                      />
                      <path
                        d="M16.5 12h4"
                        ...
                        <tr key={property._id}>
                          ...
                          <td>
                            {isFeaturedActive(property) ? (
                              ...
                              property.featuredUntil ? (
                              <span className="featured-expired-text">
                                Expired
                              </span>
                            ) : (
            ...
            <div className="dashboard-content">
              <div className="section-header">
                <div>
                  <h1>Payments</h1>
                  <p className="subtitle">
                    All payments made for featured listings
                  </p>
                </div>
              </div>
        ...
        <div className="modal-overlay" onClick={() => setInvoiceItem(null)}>
          ...
          >
            <div className="modal-header">
              ...
              <button className="btn-icon" onClick={() => setInvoiceItem(null)}>
                <FiX />
              </button>
            </div>
            <div className="invoice-body">
              <div className="invoice-brand">
                <h2>UrbanStay</h2>
                <span className={`status-badge ${invoiceItem.status}`}>
                  {invoiceItem.status}
                </span>
              </div>
              <hr />
          ...
          <div className="modal-content">
            ...
            <div className="modal-body">
              <div className="inquiry-summary">
                <p>
                  <strong>Property:</strong> {respondingTo.property?.title}
                </p>
                <p>
                  <strong>From:</strong> {respondingTo.sender?.name}
                </p>
                <p>
                  <strong>Message:</strong> "{respondingTo.message}"
                </p>
              </div>
      ...
      {featuredProperty && (
        <FeaturedUpgradeModal
          ...
          onSuccess={(updatedProp, txnId) => {
            handleFeatureSuccess(updatedProp, txnId);
      ...
      <PaymentToast
        ...
        txnId={paymentToast.txnId}
        onClose={() => setPaymentToast({ ...paymentToast, show: false })}
      />
    </div>
  );
};
