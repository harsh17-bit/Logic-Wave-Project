...
const AdminDashboard = () => {
  ...
  const [showPropertyDeleteConfirm, setShowPropertyDeleteConfirm] =
    useState(false);
      ...
      <div className="dashboard-container">
                            ...
                            <div className="action-buttons">
                              ...
                              {!property.isFeatured && (
                                <button
                                  ...
                                  onClick={() =>
                                    handleFeatureProperty(property._id)
                                  }
                                >
                                  <FiAward />
                                </button>
            ...
            <div className="dashboard-content">
              ...
              {payments.length > 0 ? (
                ...
                <div className="empty-state large">
                  ...
                  <p>
                    Transactions will appear here once sellers feature their
                    listings
                  </p>
                </div>
              )}
        ...
        {showPropertyDeleteConfirm && propertyToDelete && (
          <div
            className="modal-overlay"
            onClick={() =>
              !isDeletingProperty && setShowPropertyDeleteConfirm(false)
            }
          >
            <div
            ...
            >
              ...
              <div className="modal-body">
                <p className="warning-text">
                  ...
                  cannot be undone and will also remove all associated reviews
                  and inquiries.
                </p>
