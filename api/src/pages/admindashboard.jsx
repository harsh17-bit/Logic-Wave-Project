...
import {
    ...
    FiPhone, FiMail, FiMapPin, FiBriefcase, FiCalendar, FiUser,FiDollarSign
} from "react-icons/fi";
...
const AdminDashboard = () => {
    ...
    const [paymentStats, setPaymentStats] = useState({ count: 0, totalRevenue: 0 });
                        ...
                        <div className="dashboard-content">
                            ...
                            {payments.length > 0 ? (
                                    ...
                                    <table className="property-table">
                                        ...
                                        <tbody>
                                            {payments.map((p) => (
                                                <tr key={p._id}>
                                                    <td>
                                                        <span style={{ fontFamily: "monospace", fontSize: "0.78rem", color: "black" }}>
                                                            {p.transactionId}
                                                        </span>
                                                    </td>
                                                    <td>
                                                        <div>
                                                            <span className="user-name">{p.seller?.name || "—"}</span>
                                                            <br />
                                                            <small style={{ color: "black" }}>{p.seller?.email}</small>
                                                        </div>
                                                    </td>
                                                    ...
                                                    <td>
                                                        <span className={`status-badge ${p.status === "captured" ? "available" : "sold"}`}>
                                                            {p.status}
                                                        </span>
                                                    </td>
                                                    <td>
                                ...
                                <div className="empty-state large">
                                    ...
                                    <p>Transactions will appear here once sellers feature their listings</p>
                                </div>
                            )}
                        </div>
                    )}
