            ...
            <div className="legal-container">
                <div className="legal-content">
                    <section className="legal-section">
                        <h2><FiHome /> Welcome to Logic Wave Property</h2>
                        <p>
                            These Terms of Service ("Terms") govern your access to and use of Logic Wave Property's 
                    ...
                    <section className="legal-section">
                        ...
                        <p>
                            By creating an account, listing properties, or using any part of our Service, you acknowledge 
                    ...
                    <section className="legal-section">
                        ...
                        <ul>
                            <li><strong>Buyers/Renters:</strong> Browse and search for properties, save favorites, contact sellers</li>
                            <li><strong>Sellers/Landlords:</strong> List properties, manage listings, receive inquiries</li>
                            <li><strong>Agents:</strong> Represent clients, manage multiple listings, access advanced tools</li>
                        </ul>
                    </section>
                    ...
                    <section className="legal-section">
                        ...
                        <p>
                            Logic Wave Property may verify property listings and seller information. Verified 
                            properties receive a verification badge, but this does not constitute a guarantee 
                            or endorsement by Logic Wave Property.
                        </p>
                    </section>
                    ...
                    <section className="legal-section">
                        ...
                        <p>Creating an account and browsing properties is free for all users.</p>

                        <h3>4.2 Premium Services</h3>
                        <ul>
                            <li><strong>Featured Listings:</strong> Fees apply for premium placement</li>
                            <li><strong>Verification Services:</strong> Optional paid verification available</li>
                            <li><strong>Professional Tools:</strong> Advanced analytics and tools for agents</li>
                        </ul>

                        <h3>4.3 Refund Policy</h3>
                        <p>
                            Refunds for premium services are provided on a case-by-case basis. Please contact 
                            our support team within 7 days of purchase for refund requests.
                        </p>
                    </section>
                    ...
                    <section className="legal-section">
                        ...
                        <p>
                            All content on the Service, including text, graphics, logos, icons, images, and software, 
                            is the property of Logic Wave Property and is protected by copyright, trademark, and 
                            other intellectual property laws.
                        </p>

                        <h3>6.2 User Content</h3>
                        <p>
                            By uploading content (property listings, photos, descriptions), you grant Logic Wave 
                            Property a worldwide, non-exclusive, royalty-free license to use, display, reproduce, 
                    ...
                    <section className="legal-section">
                        ...
                        <p>
                            Your privacy is important to us. Please review our <Link to="/privacy-policy">Privacy Policy</Link> to 
                    ...
                    <section className="legal-section">
                        ...
                        <p>
                            ...
                            for the content, privacy policies, or practices of third-party sites. You access them at 
                            your own risk.
                        </p>
                    </section>
                    ...
                    <section className="legal-section">
                        ...
                        <p>
                            ...
                            not guarantee the accuracy, completeness, or reliability of property listings or user content.
                        </p>

                        <h3>9.2 Not a Real Estate Broker</h3>
                        <p>
                            Logic Wave Property is a technology platform connecting buyers and sellers. We are not a 
                            real estate broker, agent, or dealer. We do not participate in transactions or take custody 
                            of funds.
                        </p>

                        <h3>9.3 User Responsibility</h3>
                        <p>
                            Users are responsible for conducting their own due diligence, property inspections, legal 
                            reviews, and financial assessments before entering into any real estate transaction.
                        </p>
                    </section>
                    ...
                    <section className="legal-section">
                        ...
                        <p>
                            To the maximum extent permitted by law, Logic Wave Property shall not be liable for any 
                    ...
                    <section className="legal-section">
                        ...
                        <p>
                            You agree to indemnify and hold harmless Logic Wave Property and its officers, directors, 
                    ...
                    <section className="legal-section">
                        ...
                        <div className="contact-info">
                            <p><strong>Email:</strong> legal@logicwaveproperty.com</p>
                            <p><strong>Phone:</strong> +91 1800-XXX-XXXX</p>
                            <p><strong>Address:</strong> Logic Wave Property, Mumbai, India</p>
                        </div>
                    </section>

                    <div className="legal-footer">
                        <FiCheckCircle className="check-icon" />
                        <p>By using Logic Wave Property, you acknowledge that you have read and understood these Terms of Service.</p>
                ...
                <aside className="legal-sidebar">
                    <div className="sidebar-card">
                        <h3><FiAlertCircle /> Quick Links</h3>
                        <ul className="sidebar-links">
                            <li><a href="#acceptance">Acceptance of Terms</a></li>
                            <li><a href="#accounts">User Accounts</a></li>
                            <li><a href="#listings">Property Listings</a></li>
                            <li><a href="#fees">Fees and Payments</a></li>
