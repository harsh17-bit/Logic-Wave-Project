            ...
            <div className="register-container">
                ...
                <div className="register-left">
                    ...
                    <div className="register-welcome">
                        ...
                        <p>
                            Create a free account to explore thousands of premium
                            listings, save favourites, and connect with top agents.
                        </p>
                    </div>
                    ...
                    <div className="register-form-container">
                        ...
                        <form onSubmit={handleSubmit} className="register-form" noValidate>
                            ...
                            <div className="register-form-group reg-slide-2">
                                ...
                                {formErrors.name && (
                                    <span className="register-field-error">{formErrors.name}</span>
                                )}
                            </div>
                            ...
                            <div className="register-form-group reg-slide-3">
                                ...
                                {formErrors.email && (
                                    <span className="register-field-error">{formErrors.email}</span>
                                )}
                            </div>
                            ...
                            <div className="register-form-group reg-slide-4">
                                ...
                                {formErrors.phone && (
                                    <span className="register-field-error">{formErrors.phone}</span>
                                )}
                            </div>
                            ...
                            <div className="register-form-group reg-slide-5">
                                ...
                                {formErrors.password && (
                                    <span className="register-field-error">{formErrors.password}</span>
                                )}
                            </div>
